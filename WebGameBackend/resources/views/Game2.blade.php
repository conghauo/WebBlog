 ...
 <div id="drawer" class="App-drawer">
	<header id="header" class="App-header navbar-fixed-top">
		...
		<div class="container">
			...
			<div id="header-primary" class="Header-primary ButtonGroup"><button class="Dropdown-toggle Button"><span aria-hidden="true" id="Times" class="Button-icon">5 mins 9 secs </span></button> </div>
...
<script type="module" src="{{ asset('/js/game2.js') }}"> 
</script>
