   ...
   <div id="drawer" class="App-drawer"  >
    ...
    <div id="content">
        <div class="container">
          <!-- Page Content  -->
          <!-- Gay -->
          <div id="content-main" class="p-4 p-md-5 pt-5">
            <h2 class="mb-4">Level 1</h2>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-sm-2 imgUp">
                    ...
                    <label class="btn btn-primary btn-upload Lv1">
                      Upload<input
                        type="file"
                  ...
                  <!-- col-2 -->
                  <i class="fa fa-plus imgAdd imgAddLv1"></i>
                </div>
                <!-- row -->
              </div>
              <!-- container -->
            </div>
            <a class="btn btn-primary btn-submit loadSourceLv1">Load Source</a>

            <hr />
            <h2 class="mb-4">Level 2</h2>
            ...
            <div class="container" id="main">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-sm-2 imgUp">
                    <div class="imagePreview"></div>
                    <label class="btn btn-primary btn-upload Lv2">
                      Upload<input
                        type="file"
                        class="uploadFile img"
                        value="Upload Photo"
                  ...
                  <!-- col-2 -->
                  <i class="fa fa-plus imgAdd imgAddLv2"></i>
                </div>
                <!-- row -->
              </div>
              <!-- container -->
            </div>
            <a class="btn btn-primary btn-submit loadSourceLv2">Load Source</a>

            <hr />
            <h2 class="mb-4">Level 3</h2>
            ...
            <div class="container" id="main">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-sm-2 imgUp">
                    <div class="imagePreview"></div>
                    <label class="btn btn-primary btn-upload Lv3">
                      Upload<input
                        type="file"
                        class="uploadFile img"
                        value="Upload Photo"
                  ...
                  <!-- col-2 -->
                  <i class="fa fa-plus imgAdd imgAddLv3"></i>
                </div>
                <!-- row -->
              </div>
              <!-- container -->
            </div>
            <a class="btn btn-primary btn-submit loadSourceLv3">Load Source</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- JavaScript Bundle with Popper -->
	 <!-- jiquery 3.6.1 -->
    <script
      src="{{ asset('/admin_page/js/jquery-3.6.1.min.js') }}"></script>
    <script src="{{ asset('/admin_page/js/storage.js') }}"></script>
    <script type="module" src="{{ asset('/admin_page/js/game2.js') }}"></script>
