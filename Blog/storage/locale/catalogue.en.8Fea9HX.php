...
',
    ...
    'header-slideshow.admin.TransitionTime' => 'Speed of transitions between slides (default is 5 seconds)',
    'header-slideshow.admin.TransitionTime-help' => 'Put a number that indicates the transitions time (in seconds) between each slide',
    'header-slideshow.admin.TitleSlide1' => 'Title for Slide 1',
    'header-slideshow.admin.TitleSlide1-help' => 'Set here the title of your first slide',
    'header-slideshow.admin.TextSlide1' => 'Text for your slide 1',
    'header-slideshow.admin.TextSlide1-help' => 'Set here the text for your first slide',
    'header-slideshow.admin.BtnSlide1' => 'Button text for slide 1',
    'header-slideshow.admin.BtnSlide1-help' => 'Set here the text for your first slide button',
    'header-slideshow.admin.LinkOne' => 'Button Link - Slide 1',
    'header-slideshow.admin.LinkOne-help' => 'Enter a valid url for the first slide button',
    'header-slideshow.admin.ImageOne' => 'Slide Image 1',
    'header-slideshow.admin.ImageOne-help' => 'Set a valid URL to your first image in the slideshow',
    'header-slideshow.admin.TitleSlide2' => 'Title for Slide 2',
    'header-slideshow.admin.TitleSlide2-help' => 'Set here the title of your second slide',
    'header-slideshow.admin.TextSlide2' => 'Text for your slide 2',
    'header-slideshow.admin.TextSlide2-help' => 'Set here the text for your second slide',
    'header-slideshow.admin.BtnSlide2' => 'Button text for slide 2',
    'header-slideshow.admin.BtnSlide2-help' => 'Set here the text for your second slide button',
    'header-slideshow.admin.LinkTwo' => 'Button Link - Slide 2',
    'header-slideshow.admin.LinkTwo-help' => 'Enter a valid url for the second slide button',
    'header-slideshow.admin.ImageTwo' => 'Slide Image 2',
    'header-slideshow.admin.ImageTwo-help' => 'Set a valid URL to your second image in the slideshow',
    'header-slideshow.admin.TitleSlide3' => 'Title for Slide 3',
    'header-slideshow.admin.TitleSlide3-help' => 'Set here the title of your third slide',
    'header-slideshow.admin.TextSlide3' => 'Text for your slide 3',
    'header-slideshow.admin.TextSlide3-help' => 'Set here the text for your third slide',
    'header-slideshow.admin.BtnSlide3' => 'Button text for slide 3',
    'header-slideshow.admin.BtnSlide3-help' => 'Set here the text for your third slide button',
    'header-slideshow.admin.LinkThree' => 'Button Link - Slide 3',
    'header-slideshow.admin.LinkThree-help' => 'Enter a valid url for the third slide button',
    'header-slideshow.admin.ImageThree' => 'Slide Image 3',
    'header-slideshow.admin.ImageThree-help' => 'Set a valid URL to your third image in the slideshow',
    ...
    'justoverclock-custom-html-widget.forum' => NULL,
